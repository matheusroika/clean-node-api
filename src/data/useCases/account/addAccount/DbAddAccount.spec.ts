...
import type { Account, AccountParams, AddAccountRepository, Hasher, LoadAccountByEmailRepository } from './DbAddAccountProtocols'
...
const makeFakeAccountData = (): AccountParams => ({
  name: 'Any Name',
  email: 'any@email.com',
