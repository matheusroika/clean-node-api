...
import type { Account, AuthParams, HashComparer, LoadAccountByEmailRepository, Encrypter, UpdateAccessTokenRepository } from './DbAuthenticationProtocols'
...
const makeFakeAuthValues = (): AuthParams => ({
  email: 'any@email.com',
